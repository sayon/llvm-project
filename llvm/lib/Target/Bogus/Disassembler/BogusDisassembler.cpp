...
/// A disassembler class for Bogus.
class BogusDisassembler : public MCDisassembler {
public:
  BogusDisassembler(const MCSubtargetInfo &STI, MCContext &Ctx) :
...
static DecodeStatus DecodeGPRRegisterClass(MCInst &Inst, unsigned RegNo, // NOLINT
                                           uint64_t Address,
                                           const MCDisassembler *Decoder);
static DecodeStatus DecodeSImmOperand(MCInst &Inst, unsigned Val, // NOLINT
                                      uint64_t Address,
                                      const MCDisassembler *Decoder);
#include "BogusGenDisassemblerTables.inc"
...
static DecodeStatus DecodeSImmOperand(MCInst &Inst, unsigned Val,
                                        uint64_t Address,
                                        const MCDisassembler *Decoder) {
  Inst.addOperand(MCOperand::createImm(static_cast<int64_t>(Val)));
  return MCDisassembler::Success;
}
...
//   if (RegNo > 15)
//     return MCDisassembler::Fail;
//   unsigned Reg = getReg(Decoder, Bogus::RRegsRegClassID, RegNo);
//   Inst.addOperand(MCOperand::createReg(Reg));
//   return MCDisassembler::Success;
// }
...
//   switch (Opcode) {
//   case 0x0:
//     Inst.setOpcode(Bogus::STW_2rus);
//     return Decode2RUSInstruction(Inst, Insn, Address, Decoder);
//   case 0x1:
//     Inst.setOpcode(Bogus::LDW_2rus);
//     return Decode2RUSInstruction(Inst, Insn, Address, Decoder);
//   case 0x2:
//     Inst.setOpcode(Bogus::ADD_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x3:
//     Inst.setOpcode(Bogus::SUB_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x4:
//     Inst.setOpcode(Bogus::SHL_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x5:
//     Inst.setOpcode(Bogus::SHR_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x6:
//     Inst.setOpcode(Bogus::EQ_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x7:
//     Inst.setOpcode(Bogus::AND_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x8:
//     Inst.setOpcode(Bogus::OR_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x9:
//     Inst.setOpcode(Bogus::LDW_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x10:
//     Inst.setOpcode(Bogus::LD16S_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x11:
//     Inst.setOpcode(Bogus::LD8U_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x12:
//     Inst.setOpcode(Bogus::ADD_2rus);
//     return Decode2RUSInstruction(Inst, Insn, Address, Decoder);
//   case 0x13:
//     Inst.setOpcode(Bogus::SUB_2rus);
//     return Decode2RUSInstruction(Inst, Insn, Address, Decoder);
//   case 0x14:
//     Inst.setOpcode(Bogus::SHL_2rus);
//     return Decode2RUSBitpInstruction(Inst, Insn, Address, Decoder);
//   case 0x15:
//     Inst.setOpcode(Bogus::SHR_2rus);
//     return Decode2RUSBitpInstruction(Inst, Insn, Address, Decoder);
//   case 0x16:
//     Inst.setOpcode(Bogus::EQ_2rus);
//     return Decode2RUSInstruction(Inst, Insn, Address, Decoder);
//   case 0x17:
//     Inst.setOpcode(Bogus::TSETR_3r);
//     return Decode3RImmInstruction(Inst, Insn, Address, Decoder);
//   case 0x18:
//     Inst.setOpcode(Bogus::LSS_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x19:
//     Inst.setOpcode(Bogus::LSU_3r);
//     return Decode3RInstruction(Inst, Insn, Address, Decoder);
//   }
//   return MCDisassembler::Fail;
// }
...
//   switch (Opcode) {
//   case 0x0c:
//     Inst.setOpcode(Bogus::STW_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x1c:
//     Inst.setOpcode(Bogus::XOR_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x2c:
//     Inst.setOpcode(Bogus::ASHR_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x3c:
//     Inst.setOpcode(Bogus::LDAWF_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x4c:
//     Inst.setOpcode(Bogus::LDAWB_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x5c:
//     Inst.setOpcode(Bogus::LDA16F_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x6c:
//     Inst.setOpcode(Bogus::LDA16B_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x7c:
//     Inst.setOpcode(Bogus::MUL_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x8c:
//     Inst.setOpcode(Bogus::DIVS_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x9c:
//     Inst.setOpcode(Bogus::DIVU_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x10c:
//     Inst.setOpcode(Bogus::ST16_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x11c:
//     Inst.setOpcode(Bogus::ST8_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x12c:
//     Inst.setOpcode(Bogus::ASHR_l2rus);
//     return DecodeL2RUSBitpInstruction(Inst, Insn, Address, Decoder);
//   case 0x12d:
//     Inst.setOpcode(Bogus::OUTPW_l2rus);
//     return DecodeL2RUSBitpInstruction(Inst, Insn, Address, Decoder);
//   case 0x12e:
//     Inst.setOpcode(Bogus::INPW_l2rus);
//     return DecodeL2RUSBitpInstruction(Inst, Insn, Address, Decoder);
//   case 0x13c:
//     Inst.setOpcode(Bogus::LDAWF_l2rus);
//     return DecodeL2RUSInstruction(Inst, Insn, Address, Decoder);
//   case 0x14c:
//     Inst.setOpcode(Bogus::LDAWB_l2rus);
//     return DecodeL2RUSInstruction(Inst, Insn, Address, Decoder);
//   case 0x15c:
//     Inst.setOpcode(Bogus::CRC_l3r);
//     return DecodeL3RSrcDstInstruction(Inst, Insn, Address, Decoder);
//   case 0x18c:
//     Inst.setOpcode(Bogus::REMS_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   case 0x19c:
//     Inst.setOpcode(Bogus::REMU_l3r);
//     return DecodeL3RInstruction(Inst, Insn, Address, Decoder);
//   }
//   return MCDisassembler::Fail;
// }
...
BogusDisassembler::getInstruction(MCInst &instr, uint64_t &Size,
                                  ArrayRef<uint8_t> Bytes, uint64_t Address,
  ...
  DecodeStatus Result = decodeInstruction(DecoderTable32, instr, insn32, Address, this, STI);
  if (Result != Fail) {
    Size = 4;
    return Result;
  }
...
static MCDisassembler *createBogusDisassembler(const Target &T,
                                               const MCSubtargetInfo &STI,
                                               MCContext &Ctx) {
  return new BogusDisassembler(STI, Ctx);
}

extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeBogusDisassembler() {
  // Register the disassembler.
  TargetRegistry::RegisterMCDisassembler(getTheBogusTarget(),
                                         createBogusDisassembler);
}
