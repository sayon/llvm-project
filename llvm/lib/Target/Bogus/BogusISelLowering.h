//=== BogusISelLowering.h - Bogus DAG Lowering Interface --------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_Bogus_BogusISELLOWERING_H
#define LLVM_LIB_TARGET_Bogus_BogusISELLOWERING_H
...
public:
  explicit BogusTargetLowering(const TargetMachine &TM,
...
#endif // end LLVM_LIB_TARGET_Bogus_BogusISELLOWERING_H
